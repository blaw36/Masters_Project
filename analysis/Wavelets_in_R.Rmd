...
Let's see if we can replicate the above using the 'wavethresh' package
```{r wavethresh_1}
library(wavethresh)
wthresh <- wavethresh::wd(c(USAccDeaths), filter.number=1, family="DaubExPhase")
```

'wavethresh' only accepts data which has a length which is a power of two.
```{r wavethresh_2}
