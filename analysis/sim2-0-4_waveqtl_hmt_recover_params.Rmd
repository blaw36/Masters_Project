---
title: "WaveQTL with HMT - Simulation 2.0.4 - Controlled experiments"
author: "Brendan Law"
date: "12/07/2019"
output: html_document
---

Some small scale, controlled experiments.
...
## More noise! - 0.5/0.5, and 1/0, not 0/1
...
p_n_ind = 70
p_n_pheno = 1024
p_tying_grp = c(1,2,3,65,129,257,513)
p_param_pi_00 = 0
p_param_pi_11 = 1
p_grped_eps_11 = c(rep(0.7,(length(p_tying_grp)-1)),0)
p_grped_eps_10 = c(rep(0.3,(length(p_tying_grp)-1)),0)
