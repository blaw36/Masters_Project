---
title: "WaveQTL with HMT - Simulation 2.0.3 - Varying initial epsilon"
author: "Brendan Law"
date: "12/07/2019"
output: html_document
---

Experimenting with varying initial epsilon.
...
Just an experiment to see how flagging some WCs as not being used affects things. The useWCs reference here is from the Shim/Stephens file, so it doesn't really make any sense in this context (is based off different data). But this shows that by preventing a lot of WCs from being analysed means we have very few transitions to bring us away from the initialised values of 0.5.

This is as opposed to using all the WCs, but generating very strong 0->0 or 1->1 transitions at some levels.
