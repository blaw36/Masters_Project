...
Now we can run this many times, in a loop, and continue to collect resulting observations. See "code/sim2_script.R" for the simulation script. Here are some results:
```{r results1}
# setwd("~/Cpp/WaveQTL_HMT/test/dsQTL/")
