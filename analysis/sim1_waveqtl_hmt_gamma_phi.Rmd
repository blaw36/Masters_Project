...
par(mfrow = c(10,1)
    ,mar = c(2,2,2,2))
plot(vector_centeriser(gamma_seq_plot[1]),type = "h",ylab = "",axes = F)#; axis(1)
plot(vector_centeriser(gamma_seq_plot[2:3]),type = "h",ylab = "",axes = F)#; axis(1)
plot(vector_centeriser(gamma_seq_plot[4:7]),type = "h",ylab = "",axes = F)#; axis(1)
plot(vector_centeriser(gamma_seq_plot[8:15]),type = "h",ylab = "",axes = F)#; axis(1)
plot(vector_centeriser(gamma_seq_plot[16:31]),type = "h",ylab = "",axes = F)#; axis(1)
plot(vector_centeriser(gamma_seq_plot[32:63]),type = "h",ylab = "",axes = F)#; axis(1)
plot(vector_centeriser(gamma_seq_plot[64:127]),type = "h",ylab = "",axes = F)#; axis(1)
plot(vector_centeriser(gamma_seq_plot[128:255]),type = "h",ylab = "",axes = F)#; axis(1)
plot(vector_centeriser(gamma_seq_plot[256:511]),type = "h",ylab = "",axes = F)#; axis(1)
plot(vector_centeriser(gamma_seq_plot[512:1023]),type = "h",ylab = "",axes = F)#; axis(1)
```
