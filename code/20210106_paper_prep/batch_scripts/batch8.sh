...
#SBATCH -o /home/bklaw/paper_data_clean/batch_logs/test8.out        # Standard output
#SBATCH -e /home/bklaw/paper_data_clean/batch_logs/test8.err        # Standard error
...
# INSERT CODE
Rscript /home/bklaw/paper_data_clean/01_prepare_data_for_simulation_SERVER_EDIT.R 8
