run_end_to_end <- function(
  ...
  if(no.QT){
    setwd("~/Cpp/WaveQTL_HMT_wperm/batch_test/")
    # No HMT
    system(paste0("../WaveQTL" #"~/Cpp/WaveQTL_HMT_wperm/WaveQTL"
                  ," -gmode 1"
                  ," -g ~/Cpp/WaveQTL_HMT_wperm/data/dsQTL/chr17.10160989.10162012.2kb.cis.geno" # genotype (eg ../../data/dsQTL/chr17.10160989.10162012.2kb.cis.geno)
                  ...
                  ," -o paper_waveqtl_nohmt_",output.prefix # output name
                  ," -f 1024"
                  ," -numPerm ", num_perms
                  ," -fph 3"
  ...
  if(no.QT){
    ...
    system(paste0("../WaveQTL" #"~/Cpp/WaveQTL_HMT_wperm/WaveQTL"
                  ...
                  #," -group ", grouping.file # grouping file
                  ," -u ", paste0(output.path, output.prefix, "_use.txt")
                  ," -o paper_waveqtl_hmt_",output.prefix # output name
                  ," -f 1024"
                  ," -numPerm ", num_perms
                  ," -fph 3"
                  ," -hmt 1"
