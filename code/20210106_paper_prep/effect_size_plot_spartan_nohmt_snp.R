...
if(file.exists(pheno_data_path)){
  ...
  effect_size_plot_data <- effect_size_plot(
    ...
    ,plot_output_path = paste0(curr_wd,"/plots_nohmt_snp/")
    ,snp_to_use = 'nohmt'
  )
  saveRDS(effect_size_plot_data, paste0(curr_wd,"/plots_nohmt_snp/chr.",chrIX,".",site,".plot.data.RDS"), compress = TRUE)
