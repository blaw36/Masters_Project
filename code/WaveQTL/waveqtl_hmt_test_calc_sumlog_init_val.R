...
inits_loop=1
init_vars_envir <- c(ls(),"init_try","init_vars_envir")
# for(init_try in c(seq(0.2,0.8,0.2),seq(0.2,0.8,0.2))){
for(init_try in c(seq(0.6,0.8,0.1),seq(0.6,0.8,0.1))){
  ...
  remove_vars <- setdiff(ls(),init_vars_envir)
  rm(list = remove_vars);gc();
}
