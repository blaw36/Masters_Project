...
for(i in 1:578){
  ...
  null_lhoods_file <- as.numeric(read.table(paste0("/home/bklaw/actual_sims_output/null/output/fullread.70ind.",i,".fph.logLR.txt"))[2:3])
  ...
  sc_pi_null <- as.numeric(read.table(paste0("/home/bklaw/actual_sims_output/null/output/fullread.70ind.",i,".fph.pi.txt"))[2])
  ...
  null_hmt_lhoods[i] <- as.numeric(read.table(paste0("/home/bklaw/actual_sims_output/null-hmt/output/fullread.70ind.",i,".fph.logLR.txt"))[2]) + sc_logL_null
}

for(i in 1:578){
  # Read in alt l-hood file
  alt_lhoods_file <- as.numeric(read.table(paste0("/home/bklaw/actual_sims_output/alt/output/fullread.70ind.",i,".fph.logLR.txt"))[2:3])
  ...
  # alt-HMT
  # Grab scaling coefficient logBF, plus scaling coefficient pi. (from non-HMT analysis - will remain unchanged in HMT)
  sc_pi_alt <- as.numeric(read.table(paste0("/home/bklaw/actual_sims_output/alt/output/fullread.70ind.",i,".fph.pi.txt"))[2])
  # Convert out of log10
